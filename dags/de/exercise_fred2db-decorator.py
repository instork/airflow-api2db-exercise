...
def fred2db():
    ...
    def fetch_fred(templates_dict, **context):
        ...
        start_time = pendulum.from_format(start_time, "YYYYMMDDTHHmmss", tz=pendulum.timezone("UTC"))
        start_time = pendulum.timezone("US/Eastern").convert(start_time).subtract(minutes=1)
